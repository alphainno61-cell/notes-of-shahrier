...
class IndexPageController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        return response()->json(['success' => true, 'message' => 'Index page settings updated successfully!']);
    }
    ...
    public function storeLogo(Request $request)
    {
        try {
                ...
                try {
                    ...
                    if (!$path) {
                        Log::error('Failed to store logo file', [
                            ...
                            'disk_free_space' => @disk_free_space($storagePath) ?: 'unknown',
                            'disk_used' => $disk,
                        ]);
            ...
            // Catch ALL errors including fatal ones and return JSON
            Log::error('Unexpected error in storeLogo', [
            ...
            return redirect()->back()->withErrors(['general' => 'An unexpected error occurred: ' . $e->getMessage()]);
        }
    }
