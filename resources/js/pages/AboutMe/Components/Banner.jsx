          ...
          <div className="lg:px-20 px-5 pt-24 lg:pt-0">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <p className="text-3xl font-medium text-white">
                {bannerData.label || "About Me"}
              </p>
            </div>
            <h1 className="text-4xl lg:text-6xl font-semibold text-white">
              {bannerData.title || "Remarkable lives respond to a greater purpose."}
            </h1>
          </div>

          <div>
            <div>
              <img src={bannerData.banner_image || "/assets/about_me/about_me_banner.png"} alt="Banner" />
            </div>
          </div>
        </div>
      </div>
