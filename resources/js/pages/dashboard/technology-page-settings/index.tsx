                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex justify-end pt-4">
                                    <Button
                                        ...
                                        disabled={savingSection === 'cybersecurity'}
                                    >
                                        {savingSection === 'cybersecurity' ? "Saving..." : "Save Changes"}
                                    </Button>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex justify-end pt-4">
                                    <Button
                                        ...
                                        disabled={savingSection === 'contribution'}
                                    >
                                        {savingSection === 'contribution' ? "Saving..." : "Save Changes"}
                                    </Button>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex justify-end pt-4">
                                    ...
                                    >
                                        {savingSection === 'tools' ? "Saving..." : "Save Changes"}
                                    </Button>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex justify-end pt-4">
                                    <Button
                                        ...
                                        disabled={savingSection === 'blogs'}
                                    >
                                        {savingSection === 'blogs' ? "Saving..." : "Save Changes"}
                                    </Button>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="flex justify-end pt-4">
                                    <Button
                                        ...
                                        disabled={savingSection === 'icons'}
                                    >
                                        {savingSection === 'icons' ? "Saving..." : "Save Changes"}
                                    </Button>
                                </div>
                            </CardContent>
                        </Card>
