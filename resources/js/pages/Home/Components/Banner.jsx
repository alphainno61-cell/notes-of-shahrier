      ...
      {!showSplash && (<>
        <div className="w-full relative flex flex-col md:flex-row">
          <div className="md:w-2/3 h-full w-full">
            <div className="h-[500px] md:h-[600px] lg:h-[80vh] relative">
              <img
              ...
              >
                <p className={`${getFontSize('subtitle')} font-semibold p-5 lg:p-20 wrap-break-word`}>
                  {truncateText(
          ...
          <div className="md:w-1/3 w-full h-[500px] md:h-[600px] lg:h-[80vh] flex flex-col justify-center">
            <div className="flex items-center gap-4 px-5 lg:px-20 mb-6 lg:mt-48">
              <p className={`${getFontSize('tagline')} font-medium text-slate-900 wrap-break-word`}>
                {truncateText(
            ...
            <h1 className={`${getFontSize('description')} font-semibold text-slate-900 px-5 lg:px-20 wrap-break-word`}>
              {truncateText(
        ...
        <div className="w-full flex flex-col lg:flex-row min-h-36 lg:h-[20vh]">
          <div className="w-full lg:w-2/3 py-6 bg-[#3b3939d3] bg-opacity-10 backdrop-blur-sm min-h-full">
            <div className="w-11/12 mx-auto h-full flex items-center justify-center">
              <div className={`h-full grid ${statistics && statistics.length > 6
