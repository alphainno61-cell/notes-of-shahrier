...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call([
            ...
            CorporateJourneySeeder::class,
            AssociateSeeder::class,
            FeaturedBlogBannerSeeder::class,
            // Page Settings Seeders
            ContactPageSettingSeeder::class,
            AboutMePageSettingSeeder::class,
            BooksPageSettingSeeder::class,
            EntrepreneurshipPageSettingSeeder::class,
            EventsPageSettingSeeder::class,
            BlogsPageSettingSeeder::class,
            TechnologyPageSettingSeeder::class,
            DonationPageSettingSeeder::class,
